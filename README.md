...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/dockerpty-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/dockerpty-feedstock)
...
Once the `conda-forge` channel has been enabled, `dockerpty` can be installed with:

```
conda install dockerpty
```

It is possible to list all of the versions of `dockerpty` available on your platform with:
